...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Room4 Admin <sup>2</sup></div>
    </a>
    ...
    <li class="nav-item">
        ...
        <div id="collapseTables" class="collapse" aria-labelledby="headingTables" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{ route('admin.childrenTable') }}">Children</a>
                <a class="collapse-item" href="{{ route('admin.teachersTable') }}">Teachers</a>
                <a class="collapse-item" href="{{ route('admin.classesTable') }}">Classes</a>
                <a class="collapse-item" href="parents.html">Parents</a>
            </div>
        </div>
    </li>
